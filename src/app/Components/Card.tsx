...
const Card: React.FC<CardProps> = ({ tag, tagColor, title, description, link }) => {
  return (
    <div className="bg-white rounded-lg shadow-lg p-2 pb-3 lg:p-4 relative z-10">
      ...
      <Link href={link} className=" text-blue-600 border-2 ml-1 py-2 px-2 lg:px-10 justify-center items-center text-center rounded-md border-blue-600 mt-4 inline-block text-sm">
        Take Lesson
      </Link>
      </div>
    </div>
